...
> Design notes for **realtime-order-notifications** — a runnable typescript example that Typed Node service that publishes validated checkout and fulfillment updates to private customer channels.
...
- **Feature code** — the actual task: realtime order updates.
